            ...
            <div className="relative z-10 bg-gradient-to-br from-primary-400 to-purple-500 rounded-2xl p-8 shadow-2xl">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 text-gray-700 dark:text-gray-300">
                <p className="text-lg leading-relaxed mb-4">
                  I'm a full-stack developer obsessed with building web apps that feel effortless, where the tech disappears and the experience just works. Clean code, intuitive design, and a touch of chaos keep it alive.
                </p>
